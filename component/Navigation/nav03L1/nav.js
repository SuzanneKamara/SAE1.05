...
const templateFile = await fetch("component/Navigation/nav03L1/template.html");
...
const templateFile2 = await fetch("component/Navigation/nav03L1/li.html");
...
Navigation.render = function( where, what ){
    ...
    let html="";
    for (let obj of what){
      html=html+Navigation.format(obj);
    }
